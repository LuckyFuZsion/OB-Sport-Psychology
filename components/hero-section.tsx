      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6 lg:px-8 w-full pt-28 pb-20 lg:py-32">
        <div className="max-w-3xl w-full lg:ml-auto text-left lg:text-right rounded-2xl border border-card-border bg-card/95 text-card-foreground backdrop-blur-sm shadow-xl shadow-black/25 p-6 sm:p-8 lg:rounded-none lg:border-0 lg:bg-transparent lg:text-white lg:shadow-none lg:backdrop-blur-none lg:p-0">
          <h1 className="text-4xl sm:text-5xl lg:text-7xl font-bold text-card-foreground lg:text-white leading-[1.05] tracking-tight mb-4 lg:[text-shadow:0_2px_24px_rgba(0,0,0,0.9)]">
            <span className="block hero-enter hero-enter-1">OB</span>
            <span className="block hero-enter hero-enter-2">SPORT</span>
            <span className="block hero-enter hero-enter-3">PSYCHOLOGY</span>
          </h1>

          <p className="hero-enter hero-enter-4 text-xl sm:text-2xl lg:text-3xl font-semibold text-card-foreground lg:text-white leading-snug mb-8 lg:mb-10 lg:[text-shadow:0_2px_24px_rgba(0,0,0,0.9)]">
            <span>Helping people </span>
            <span className="text-brand-blue hero-flourish">flourish.</span>
          </p>

          <a
            href="#services"
            className="hero-enter hero-enter-5 btn-motion inline-flex items-center justify-center px-7 py-4 text-sm font-semibold rounded-md bg-primary text-primary-foreground hover:bg-primary/90 shadow-lg shadow-primary/25 hover:shadow-primary/35 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring w-full sm:w-auto lg:ml-auto"
          >
            View services
          </a>
        </div>
